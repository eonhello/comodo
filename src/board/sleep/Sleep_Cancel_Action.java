...
import db.board.sleep.BoardDAOImpl;
 ...
 public class Sleep_Cancel_Action {
...
//		 }
		 ...
		 try{
			 ...
			 boarddata.setS_cancel(1);
			 request.setAttribute("boardlist", boarddata);
			 System.out.println("취소통과 게시글번호 = "+boarddata.getS_board_num());
			 System.out.println("취소통과 CONFIRM 번호 = "+boarddata.getS_cancel());
...
//			 System.out.println("Modify_Action 내용 = "+request.getParameter("S_BOARD_CONTENT"));
		...
		//	 result = boarddao.boardModify(boarddata);
			// boarddao.boardEdit(boarddata);
			 boarddao.boardCancel(boarddata);
			 /*if(result==false){
