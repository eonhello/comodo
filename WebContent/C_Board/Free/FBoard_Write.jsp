				...
				<form name="BoardWriteForm" method="post"
					...
					<div class="container" style="margin-top: 50px">
						<table summary="테이블 구성" class="table table-bordered">
							...
							<tr>
								<td>작성자</td>
								<td><input type=text name=board_name size=10 maxlength=8
									value="<%=session.getAttribute("sessionName")%>" readonly></td>
							</tr>
							<tr>
								<td>학번</td>
								<td><input type=text name=hak_num size=10 maxlength=8
									value="<%=session.getAttribute("sessionHaknum")%>" readonly></td>
							</tr>
							<tr>
								<td>제 목</td>
							...
							<tr>
								<td colspan="2"><div align="center">
										<input type="submit" value="등록" role="button"
											class="btn btn-success">&nbsp;&nbsp; <input
											type="button" value="뒤로" role="button"
